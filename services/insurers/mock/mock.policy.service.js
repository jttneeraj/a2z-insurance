...
class MockPolicyService {
    async checkPolicyStatus({ insurerId, payload, logContext = {} }) {
        ...
        try {
            apiLog = await InsurerApiLogService.createLog({
                ...
                ...logContext,
                api_name: "MOTOR_POLICY_STATUS",
                api_endpoint: "/mock/motor/policy/status",
                integration_id: null,
                http_method: "POST",
            ...
            const responsePayload = {
                ...
                payment_status: "PAID",
                kyc_status: "DONE",
                insurer_policy_id: `MOCK-POL-ID-${Date.now()}`,
            };
    ...
    async generatePdf({ insurerId, payload, logContext = {} }) {
        ...
        const requestPayload = {
            policy_id: payload.policy_id || payload.policyId || "MOCK-POL-ID",
            policy_number: payload.policy_number || payload.policyNumber || "MOCK-POLICY",
        };
        ...
        try {
            apiLog = await InsurerApiLogService.createLog({
                ...
                insurer_code: insurerCode,
                ...logContext,
                api_name: "MOTOR_POLICY_PDF",
                api_endpoint: "/mock/motor/policy/pdf",
                integration_id: null,
                http_method: "POST",
                request_headers: null,
                request_payload: requestPayload,
            ...
            const responsePayload = {
                document_url: `https://mock-policy.local/policy/${requestPayload.policy_number}.pdf`,
                document_code: "MOCK_POLICY_SCHEDULE",
                document_source: "MOCK",
                schedule_dms_doc_id: `MOCK-DMS-${Date.now()}`,
            };
...
module.exports = new MockPolicyService();
