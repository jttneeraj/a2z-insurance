...
const {
    MysqlQuoteInsurerRequestsModel,
    mysqldb,
} = require(process.env.SHARED_LIBRARY_PATH + "/services/models");

class QuoteInsurerRequestsModel extends MysqlQuoteInsurerRequestsModel {
    constructor() {
        super();
    }
...
module.exports = {
    mysqldb,
    MysqlQuoteInsurerRequestsModel: new QuoteInsurerRequestsModel(),
};