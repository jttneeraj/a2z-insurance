...
const {
    MysqlQuoteInsurerResponsesModel,
    mysqldb,
} = require(process.env.SHARED_LIBRARY_PATH + "/services/models");

class QuoteInsurerResponsesModel extends MysqlQuoteInsurerResponsesModel {
    constructor() {
        super();
    }
...
module.exports = {
    mysqldb,
    MysqlQuoteInsurerResponsesModel: new QuoteInsurerResponsesModel(),
};